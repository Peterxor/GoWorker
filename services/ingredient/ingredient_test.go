...
func TestMemberHasIngrediantService_Start(t *testing.T) {
	...
	var memberHasIngrediantService MemberHasIngrediantService
	memberHasIngrediantService.Start(ingredientQueueParam)
}
